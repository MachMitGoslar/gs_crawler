...
# variablen
json_all = "053-tschuessschule-praktikum-alle.json"
json_one = "053-tschuessschule-praktikum.json"
title = "Praktikumsangebote"

# Zielseite
url = "https://tschuessschule.de/praktikum/"
